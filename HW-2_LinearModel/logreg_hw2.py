...
def calculateNegativeLogLikelihood(X,y,w):
  logConstant = 0.0000001
  logistic_wXi = logistic(X @ w)
  return -np.sum(y * np.log(logistic_wXi + logConstant) + (1 - y) * np.log(1 - logistic_wXi + logConstant))
